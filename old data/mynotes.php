<?php
    ...
    $data = $obj->get_notes($_SESSION['user_id']);
?>

<section class="main mynotes">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-secondary save-note-btn" id="save-note-btn" onclick="save_note()" style="display: none;">Save</button>
